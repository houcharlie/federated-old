...
--server_learning_rate=$1 --switch_round=$2 --control=$3 --swap_round=$4 --multistage=1 --total_rounds=5000\
--experiment_name=CIFARMULTILONG_3_$1_switch_$2_control_$3_swapround_$4